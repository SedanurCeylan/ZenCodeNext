  ...
  return (
    <div >
      ...
      <section className="container my-5">
        <h2 className="text-center mb-4 text-primary font-weight-bold">Müşteri Yorumları</h2>


        <div id="customerReviewsCarousel" className="carousel slide" data-ride="carousel">
          <div className="carousel-inner">


            <div className="carousel-item active">
              <div className="card p-4 shadow-sm border-0 rounded-3 text-center">
                <p className="text-muted">"ZenCode ekibi sayesinde işletmemizin dijital dönüşümünü başarıyla tamamladık! Profesyonel ve güvenilir bir ekip."</p>
                <h5 className="font-weight-bold">- Cansu Çevik</h5>
              </div>
            </div>
            <div className="carousel-item">
              <div className="card p-4 shadow-sm border-0 rounded-3 text-center">
                <p className="text-muted">"Hızlı, kaliteli ve müşteri odaklı bir hizmet anlayışları var. Harika bir deneyimdi!"</p>
                <h5 className="font-weight-bold">- Emirhan Körhan</h5>
              </div>
            </div>
            <div className="carousel-item">
              <div className="card p-4 shadow-sm border-0 rounded-3 text-center">
                <p className="text-muted">"Mobil uygulamamız için harika bir iş çıkardılar. Kullanıcı deneyimi mükemmel!"</p>
                <h5 className="font-weight-bold">- Sedanur Ceylan</h5>
              </div>
            </div>

          </div>
          <a className="carousel-control-prev" href="#customerReviewsCarousel" role="button" data-slide="prev">
            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
            <span className="sr-only">Önceki</span>
          </a>
          <a className="carousel-control-next" href="#customerReviewsCarousel" role="button" data-slide="next">
      ...
      <section className="container my-5">
        <h2 className="text-center mb-4 text-primary font-weight-bold">Bize Ulaşın</h2>
        <form className="w-75 mx-auto p-4 border rounded shadow-sm bg-light">

          <div className="mb-3">
            <label className="form-label" htmlFor="name">Adınız</label>
            <input type="text" className="form-control form-control-lg" id="name" placeholder="Adınızı girin" />
          </div>

          <div className="mb-3">
            <label className="form-label" htmlFor="email">E-posta</label>
            <input type="email" className="form-control form-control-lg" id="email" placeholder="E-posta adresinizi girin" />
          </div>

          <div className="mb-3">
            <label className="form-label" htmlFor="message">Mesajınız</label>
            <textarea className="form-control form-control-lg" id="message" rows="4" placeholder="Mesajınızı yazın"></textarea>
          </div>

          <div className="text-center">
            <button type="submit" className="btn btn-primary btn-lg w-100">Gönder</button>
          </div>
        </form>
      </section>
